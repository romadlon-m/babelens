-- Adds p_kondisi_label = 'tidak_lolos' (screener_passed = false) alongside
-- 'lolos_tidak'. Same signature as before, so plain create or replace.
...
begin
  ...
  if p_kondisi_label is not null and p_kondisi_label not in ('lolos_tidak', 'tidak_lolos') then
